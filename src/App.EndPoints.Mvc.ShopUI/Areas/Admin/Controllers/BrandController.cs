    ...
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get,
                "https://localhost:7137/api/Brand/GetBrand");
            ...
            {
                var brandsModel = responseBodyModel.Select(p => new BrandOutputViewModel()
                {
                    Id = p.Id,
                    Name = p.Name,
            ...
            var httpResponse = await client.PostAsync("https://localhost:7137/api/Brand/SetBrand", httpContent);
