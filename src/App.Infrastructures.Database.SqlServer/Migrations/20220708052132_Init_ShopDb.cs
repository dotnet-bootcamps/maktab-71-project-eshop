        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    ParentCagetoryId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileTypeExtentions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FileTypeExtentionId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_fileTypes_FileTypeExtentions_FileTypeExtentionId",
                        column: x => x.FileTypeExtentionId,
                        principalTable: "FileTypeExtentions",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorySpacifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategorySpacifications_Categories",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CategorySpacifications_TagCategories",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionProducts_Products_CollectionId",
                        column: x => x.CollectionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditorOperationId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductFiles_fileTypes_FileTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategorySpacifications_CategoryId",
                table: "CategorySpacifications",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategorySpacifications_TagCategoryId",
                table: "CategorySpacifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_fileTypes_FileTypeExtentionId",
                table: "fileTypes",
                column: "FileTypeExtentionId");
